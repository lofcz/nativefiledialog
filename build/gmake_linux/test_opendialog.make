...
ifeq ($(config),release_x64)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../lib/Release/x64 -L/usr/lib64 -Wl,-rpath,'$$ORIGIN/../lib/Release/x64' -m64 -s -lnfd `pkg-config --libs gtk+-3.0`
...
ifeq ($(config),release_x86)
  ...
  ALL_LDFLAGS += $(LDFLAGS) -L../lib/Release/x86 -L/usr/lib32 -Wl,-rpath,'$$ORIGIN/../lib/Release/x86' -m32 -s -lnfd `pkg-config --libs gtk+-3.0`
  LINKCMD = $(CC) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),release_arm64)
  ...
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/test_opendialog
  OBJDIR = ../obj/arm64/Release/test_opendialog
  DEFINES += -DNDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
  ...
  ALL_RESFLAGS += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  LIBS += ../lib/Release/arm64/libnfd.so
  LDDEPS += ../lib/Release/arm64/libnfd.so
  ALL_LDFLAGS += $(LDFLAGS) -L../lib/Release/arm64 -Wl,-rpath,'$$ORIGIN/../lib/Release/arm64' -s -lnfd `pkg-config --libs gtk+-3.0`
  LINKCMD = $(CC) -o "$@" $(OBJECTS) $(RESOURCES) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
  endef
  define PRELINKCMDS
...
ifeq ($(config),debug_arm64)
  ...
  TARGETDIR = ../bin
  TARGET = $(TARGETDIR)/test_opendialog_d
  OBJDIR = ../obj/arm64/Debug/test_opendialog
  DEFINES += -DDEBUG
  INCLUDES += -I../../src/include
  FORCE_INCLUDE +=
  ALL_CPPFLAGS += $(CPPFLAGS) -MMD -MP $(DEFINES) $(INCLUDES)
